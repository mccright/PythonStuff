...
[Python F-String Codes I Use Every Day](https://pybit.es/articles/python-f-string-codes-i-use-every-day/) by Pawel Jastrzebski  
...
* Experiment with '[textual](https://github.com/Textualize/textual)' (a *Rapid Application Development* framework for Python) and '[textual-web](https://github.com/Textualize/textual-web).'  Also see: [https://www.textualize.io/](https://www.textualize.io/) and [https://textual.textualize.io/](https://textual.textualize.io/)  
...
* mininterface GUI / CLI builder: [Edvard Rejthar](https://github.com/e3rd) says "[all the code you need. No lengthy blocks of code imposed by an external dependency. Besides the GUI/TUI, you receive powerful YAML-configurable CLI parsing.](https://github.com/CZ-NIC/mininterface/?tab=readme-ov-file#you-got-cli)" [https://github.com/CZ-NIC/mininterface/](https://github.com/CZ-NIC/mininterface/)  
